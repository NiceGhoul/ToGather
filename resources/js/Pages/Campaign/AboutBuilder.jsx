   ...
   const [successPopupMessage, setSuccessPopupMessage] = useState("");
    ...
    const handleRemove = (id, index) => {
        if (id != undefined) {
            ...
            router.post(`/campaigns/deleteContent/${id}`, {id}, {
                onSuccess: () => {
                    setSuccessPopupMessage("About Us block deleted!");
        ...
        if (description.some((dat) => dat.content === "")) {
            ...
            const prepared = description.map((block) => {
             ...
             router.post("/campaigns/insertAbout", prepared,{
                ...
                onSuccess: () => {
                    setSuccessPopupMessage("About Us section updated successfully!");
                    setSuccessPopupOpen(true);
                }
             }, )
             setDescription(contents)
    ...
    return (
        <div>
            ...
            <div className="relative grid grid-cols-[1fr_auto] gap-6">
             ...
             backdrop-blur p-3 shadow-sm">
                    <div className="flex flex-col gap-3">
                        <div className="font-semibold text-lg dark:text-white justify-center text-center">
                        {"Add Blocks"}
                        </div>
                ...
                <Card className="w-full h-full p-6 border border-gray-300 dark:border-gray-700 shadow-sm justify-center flex flex-col dark:bg-gray-800">
                    ...
                    description.some((dat) =>
                        oldDescription.map((a) => a === dat),
                    ) ? (
