...
export default function Transaction({ donations, stats }) {
    ...
    const getStatusBadge = (status) => {
        ...
        return (
            <Badge className={`px-3 py-1 text-sm font-medium ${variants[status]}`}>
    ...
    const filteredDonations = donations.filter(donation =>
        donation.user?.nickname?.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            <div className="bg-gray-50 py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Monitor all donation transactions</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold text-green-600">{stats?.successful_count || 0}</div>
                            </CardContent>
                        </Card>
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        <p className="font-semibold text-gray-900">
                                                            {donation.anonymous ? 'Anonymous' : donation.user?.nickname || 'Unknown'}
                                                        </p>
                                                        {getStatusBadge(donation.status)}
                                                    </div>
                                                    <p className="text-sm text-gray-600">
                                                        Donated to: {donation.campaign?.title || 'Unknown Campaign'}
                                                    </p>
