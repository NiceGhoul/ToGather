                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-600 dark:text-white">
                            Your generosity can make a real difference in
                            someone's life
                        </p>
                    </div>
                    ...
                    <Card className="shadow-lg border-0">
                        <CardContent className="p-5">
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    <Label
                                        htmlFor="amount"
                                        className="text-base font-semibold flex items-center gap-2 dark:text-white"
                                    >
                                        ...
                                        {presetAmounts.map((amount) => (
                                            <Button
                                                ...
                                                className={`h-12 text-sm font-medium transition-all ${
                                                    formData.amount == amount
                                                        ? "bg-purple-200 text-purple-700 shadow-md dark:bg-purple-800 dark:text-white hover:bg-purple-200 dark:hover:bg-purple-800"
                                                        : "bg-white text-gray-900 hover:bg-purple-200 dark:bg-gray-800 dark:text-white dark:hover:bg-purple-800"
                                                }`}
                                                onClick={() =>
                                                    setFormData((prev) => ({
                                                        ...prev,
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            required
                                        />
                                        <div className="p-2 bg-purple-200 text-purple-700 rounded border border-gray-200 dark:bg-purple-800 dark:text-white dark:border-gray-600">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-between text-xs text-gray-500 dark:text-white">
                                        <span>
                                            Your message will be shared with the
                                            campaign organizer
                                        </span>
                                        <span>
                                    ...
                                    <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded border mt-4 dark:bg-gray-800 dark:border-gray-600">
                                        ...
                                        <div>
                                            <Label
                                                htmlFor="anonymous"
                                                className="text-sm cursor-pointer font-medium dark:text-white"
                                            >
                                                Donate anonymously
                                            </Label>
                                            <p className="text-xs text-gray-600 mt-1 dark:text-white">
                                                Your name won't be displayed
                                                publicly with this donation
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <CardFooter className="p-5">
                            <Button
                                ...
                                className="w-full h-12 text-base font-semibold bg-purple-200 text-purple-700 shadow-md dark:bg-purple-800 dark:text-white hover:bg-purple-300 dark:hover:bg-purple-700 transition-all duration-200 "
                                disabled={
                                    !formData.campaign_id || !formData.amount
                                }
                            >
